...
class ResNet(nn.Module):
    ...
    def _load_moco_checkpoint(self, logger=None):
        ...
        # logger.info('loaded keys {}'.join(state_dict.keys()))
        # print('loaded keys ', str(state_dict.keys()), self.pretrained)
        new_state_dict = {}
        for key in state_dict:
            if 'module.encoder_q' in key:
                new_state_dict[key[len('module.encoder_q.'):]] = state_dict[key]
        # print('converted keys {}', str(new_state_dict.keys()))
    ...
    def init_weights(self):
        ...
        if isinstance(self.pretrained, str):
            ...
            if self.torchvision_pretrain:
                ...
                logger.info(f'Loading {self.pretrained} as moco pretrain')
