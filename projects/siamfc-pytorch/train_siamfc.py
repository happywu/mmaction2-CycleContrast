...
def main():
    ...
    if args.pretrained is not None:
        ...
        if args.moco_pretrain:
            cfg.model.backbone.moco_pretrain = True
            cfg.model.backbone.torchvision_pretrain = False
